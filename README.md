...
[![Test](https://github.com/romanSPB15/tui-compose/actions/workflows/test.yml/badge.svg)](https://github.com/romanSPB15/tui-compose/actions/workflows/test.yaml)
...
| Критерий                     | tui-compose(v3.5.2)                                          | termui(v3.1.0)                          |
|------------------------------|--------------------------------------------------------------|-----------------------------------------|
| Размер                       | ✅ ~10000 строк                                              | ✅ 4325 строк + 5393(termbox-go)       |
| Возраст                      | ✅ 3 месяца                                                  | ❌ 12 лет                              |
| Набор виджетов               | ✅ Огромный(20) — от кнопок до графиков                      | ⚠ Средний(~14)                         |
...
| Гиперссылки                  | ✅ NewHyperlink                                              | ❌ Нет                                 |
| Парадигма                    | ✅ Императивность + 2 реактивных надстройки(`tea` + `react`) | ⚠ Только императивно                   |
